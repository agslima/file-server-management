...
// governancePolicyHash computes the SHA-256 hex digest of the JSON representation of the provided GovernancePolicy.
// It returns the hex-encoded digest, or an empty string if the policy cannot be serialized.
