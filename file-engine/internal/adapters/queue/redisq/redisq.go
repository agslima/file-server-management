...
// withActorTenantKey returns a map containing "actor_id", "tenant_id", and "idempotency_key" whose values are the provided inputs trimmed of leading and trailing whitespace.
