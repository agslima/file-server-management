...
/**
 * Parse an HTTP response as JSON, returning an empty object if parsing fails.
 *
 * @param {Object} response - HTTP response object with a `json()` method.
 * @returns {Object} The parsed JSON body, or an empty object if parsing fails.
 */
